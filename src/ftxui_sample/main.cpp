...
// configuration step. It creates a namespace called `vkgsplat`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", vkgsplat::cmake::project_name, vkgsplat::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", vkgsplat::cmake::project_version);
      return EXIT_SUCCESS;
    }
